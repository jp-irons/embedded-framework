...
common::Result DeviceApiHandler::handleInfo(HttpRequest& /*req*/,
    ...
    std::string json =
        ...
        "\"freeInternalHeap\":"    + std::to_string(i.freeInternalHeap)    + ","
        "\"minFreeInternalHeap\":" + std::to_string(i.minFreeInternalHeap) + ","
        "\"largestFreeInternalBlock\":" + std::to_string(i.largestFreeInternalBlock) + ","
