...
// ------------------------------------------------------------
// Top‑level UI
extern const uint8_t _binary__index_html_start[] asm("_binary__index_html_start");
extern const uint8_t _binary__index_html_end[] asm("_binary__index_html_end");

extern const uint8_t _binary__app_js_start[] asm("_binary__app_js_start");
extern const uint8_t _binary__app_js_end[] asm("_binary__app_js_end");

extern const uint8_t _binary__style_css_start[] asm("_binary__style_css_start");
extern const uint8_t _binary__style_css_end[] asm("_binary__style_css_end");
...
static const AssetEntry assets[] = {
    // Top‑level UI
    {"/index.html", _binary__index_html_start, _binary__index_html_end},
    {"/app.js", _binary__app_js_start, _binary__app_js_end},
    {"/style.css", _binary__style_css_start, _binary__style_css_end},
